...
{
    public partial class AdmEmpregados : Form
    {
        public AdmEmpregados()
        {
            InitializeComponent();
        }
        ...
        private void AdmEmpregados_Load(object sender, EventArgs e)
        {
            MySqlConnection conn = new MySqlConnection(mySqlString);
            string sql = "select * from empregados_tb";
